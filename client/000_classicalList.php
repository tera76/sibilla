...
// http://localhost/sibilla/client/000paraMix.php?q0state=1&q1state=1&q1state=2&q0rot=2
...
$list_s_n  = array("a","a","a","a","a","a","a","c","a","c","a");
...
echo "<br> misussssssssssssssse stessa^ feetback? retroazione";
echo "<br> il sistema operativo della natura";
echo "<br> n primi, cerchio risonaze ";
