...
sort($counts);
    ...
    */
    ...
    printStepMessage("Come fa a sapere Alice che le sue misure sono correlate alle misure di Bob? ", "");

    printStepMessage("Alice dovrebbe chiamare Bob e chiedergli la sua percentuale?", "");
